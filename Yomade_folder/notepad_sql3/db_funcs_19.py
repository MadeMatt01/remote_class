...
def create_tables(): 
    with connection.cursor() as Cursor:
        ...
        create_cases_table = """CREATE table IF NOT EXISTS cases_with_recoveries (ID int(10) AUTO_INCREMENT PRIMARY KEY NOT NULL, Country_ID INT(10), 
...
#       connection.commit()
#
def write_case_with_recoveries(Country_ID, Date, Cases, Deaths, Recoveries):

    with connection.cursor() as Cursor:
        
        add_cases = f"INSERT INTO cases_with_recoveries(Country_ID, Date, Cases, Deaths, Recoveries) values('{Country_ID}','{Date}','{Cases}', '{Deaths}', '{Recoveries}')"
